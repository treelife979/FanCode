...
from fancode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from fancode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from fancode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
