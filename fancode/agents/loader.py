...
PROJECT_AGENTS_DIR = ".fancode/agents"
USER_AGENTS_DIR = "~/.fancode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("fancode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from fancode.agents.parser import parse_frontmatter, _validate_agent_meta
