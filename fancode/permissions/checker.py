...
from fancode.permissions.dangerous import DangerousCommandDetector, is_safe_command
from fancode.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from fancode.permissions.rules import Rule, RuleEngine, evaluate_rules, extract_content
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".fancode/plans/" in target_path
        try:
