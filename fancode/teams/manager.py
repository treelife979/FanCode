...
from fancode.teams.backend_detect import BackendDetectionError, detect_backend
from fancode.teams.mailbox import Mailbox, create_message
...
from fancode.teams.progress import TeammateProgress
from fancode.teams.registry import AgentNameRegistry
from fancode.teams.shared_task import SharedTaskStore
from fancode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from fancode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
            elif backend_type == BackendType.ITERM2.value:
                from fancode.teams.spawn_iterm2 import kill_pane
                kill_pane(pane_id)
