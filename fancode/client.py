...
from fancode.mcp.loading_strategy import NATIVE_TOOL_SEARCH_BETA
from fancode.conversation_pairing import ensure_tool_pairing
from fancode.serialization import (
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .fancode/config.yaml or via ANTHROPIC_API_KEY env var."
            )
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .fancode/config.yaml or via OPENAI_API_KEY env var."
            )
