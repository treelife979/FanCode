...
from fancode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from fancode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from fancode.agents.trace import TraceManager, TraceNode
from fancode.agents.task_manager import BackgroundTask, TaskManager
from fancode.agents.notification import format_task_notification, inject_task_notifications
from fancode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".fancode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from fancode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from fancode.tools.agent_tool import AgentToolParams
